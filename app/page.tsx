...
export default function Home() {
  return (
    <div className="relative  justify-center h-full items-center gap-6 w-full overflow-hidden">
     ...
     <div className="w-full justify-center items-center flex flex-col">
        ...
        <div className='flex flex-col text-center mt-3 px-2 text-zinc-400'>
          Frontend Engineer focused on scalable UI systems & UX
        ...
        <div className='mt-6 gap-4 w-full px-4'>
          <span className={`${press.className}`}>Hobbies</span>
          <div className='grid grid-cols-2 md:grid-cols-4 gap-4 w-full'>
            <img className='w-full h-full object-cover aspect-square' src="https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExY3BmZjdtczBldzRpcm9lem5wejV1Z2FscHJsenF3eG16ZHc3ZndqcSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/WoWm8YzFQJg5i/giphy.gif" alt="wanna guess?" />
            <img className='w-full h-full object-cover aspect-square' src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExMHY1cXB1bDZidGxrbW5jN29sdjl2N21xMnVueW00NXF0eXgyanpvOSZlcD12MV9naWZzX3NlYXJjaCZjdD1n/gQJyPqc6E4xoc/giphy.gif" alt="wanna guess?" />
            <img className='w-full h-full object-cover aspect-square' src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExM290eWR3aWY1YjFxMXVseTExbjBqYWwxcXZxb2pwbGF3Y284Y2NpdSZlcD12MV9naWZzX3NlYXJjaCZjdD1n/TTPi3fB9F5Aqs/giphy.gif" alt="wanna guess?" />
            <img className='w-full h-full object-cover aspect-square' src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExMmYxcG43aHd1c21ucHJzNGRod3FmYWtjdnJvdW4zZXMzYXRseWlwcyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/7DIF9HAz65YE8/giphy.gif" alt="wanna guess?" />
          </div>
        </div>
          ...
          <div className='grid grid-cols-2 md:grid-cols-4 gap-4 w-full'>
            <img className='w-full h-full object-cover aspect-square' src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExODQxbzhzajJzMjJydnRub3o2anRib25icWJoNGFpdGFmd2xyOXRqdCZlcD12MV9naWZzX3NlYXJjaCZjdD1n/9D8SldWd6lmVbHwRB1/giphy.gif" alt="Header Image" />
            <img className='w-full h-full object-cover aspect-square' src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExOXFva3E2dHk5Z3Jub3B4cDVkY2l4ZmMzeTJ0bzRpb3BweGZiZWZjbSZlcD12MV9naWZzX3NlYXJjaCZjdD1n/EZ5SX3ZYRD05ynKiQQ/giphy.gif" alt="Hobby Image" />
            <img className='w-full h-full object-cover aspect-square' src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExZnNxOXBpemJ5bGtoN3R3bGs4aDA0NmV6bXp5MGhuaTZtNnloZTRqcyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/xT0xewI2LTlJwj5hJe/giphy.gif" alt="Hobby Image" />
            <img className='w-full h-full object-cover aspect-square' src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExdmhpMjZ0d3p1ZTJmZjgzMHQ3c29jajc0MXkwc2F3YjB0a2xhdzd6biZlcD12MV9naWZzX3NlYXJjaCZjdD1n/zAYZOtH5OMhuU/giphy.gif" alt="Hobby Image" />
          </div>
        </div>
